...
<div class="wrap">
    <h1>Nutrition Labels - Configuration</h1>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <select name="qr_size" id="qr_size">
                            <?php require_once NUTRITION_LABELS_PLUGIN_DIR . 'admin/settings-functions.php'; echo qr_size_options($qr_size); ?>
                        </select>
                        <p class="description">Choose QR code size for download. Smaller sizes are better for small labels, larger for posters.</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">Length affects uniqueness vs readability. Shorter codes may conflict more often.</p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="character_set" id="character_set">
                            <?php require_once NUTRITION_LABELS_PLUGIN_DIR . 'admin/settings-functions.php'; echo character_set_options($character_set); ?>
                        </select>
                        <p class="description">Characters to exclude for readability: 0, O, I, l.</p>
                    </td>
                </tr>
                
                <tr>
                    <th scope="row">
                        <label>Current URL Format</label>
                    </th>
                    <td>
