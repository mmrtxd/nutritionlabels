<?php
/**
 * Simple meta box template with table-based nutrition data
 */
...
// Initialize nutrition data if not provided (when called directly)
if (!isset($nutrition_data)) {
    $db = new NutritionLabels_DB_Extended();
    $nutrition_data = $db->get_complete_nutrition_data($product_id);
}
...
<div class="nutrition-fields">
    ...
    <input type="number" 
           ...
           value="<?php echo esc_attr($nutrition_data['calories'] ?? 0); ?>" 
           step="1" 
           min="0" 
           max="10000" 
           style="width: 100%;">
    ...
    <input type="number" 
           name="nutrition_kilojoules" 
           value="<?php echo esc_attr($nutrition_data['kilojoules'] ?? 0); ?>" 
           step="1" 
           min="0" 
           max="40000" 
           style="width: 100%;">
    ...
    <input type="number" 
           ...
           value="<?php echo esc_attr($nutrition_data['carbohydrates'] ?? 0); ?>" 
           step="0.1" 
           min="0" 
           max="1000" 
           style="width: 100%;">
    ...
    <input type="number" 
           ...
           value="<?php echo esc_attr($nutrition_data['sugar'] ?? 0); ?>" 
           step="0.1" 
           min="0" 
           max="1000" 
           style="width: 100%;">
    ...
    <button type="button" 
            ...
            style="margin-top: 10px;">Download QR Code</button>
